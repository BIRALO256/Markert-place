        ...
        <div class="row row-centered">
            <div class="col-md-8 col-centered">
                <form class="form-auth-small" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group">
                        <label for="phone_number" class="control-label sr-only">Phone Number</label>
                        <input type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" id="signup-email" name="phone" value="{{ old('name') }}" required autofocus placeholder="Phone Number">
                        @if ($errors->has('phone'))
                        <span class="invalid-feedback" role="alert">
